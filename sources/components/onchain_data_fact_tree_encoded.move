module starknet_addr::onchain_data_fact_tree_encoded {
    ...
    public fun encode_fact_with_onchain_data(
        ...
        vector::append(&mut buffer, bytes::num_to_bytes_be(&main_public_input_length));
        vector::append(&mut buffer, bytes::num_to_bytes_be(&fact_data.onchain_data_hash));
        vector::append(&mut buffer, bytes::num_to_bytes_be(&(main_public_input_length + fact_data.onchain_data_size)));
