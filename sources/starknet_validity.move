module starknet_addr::starknet_validity {
    ...
    public entry fun update_state(
        ...
        let fact_data = onchain_data_fact::new(onchain_data_hash, onchain_data_size);
    ...
    public entry fun blob_submission(
        blob: vector<vector<u8>>,
    ...
    public(friend) fun verify_kzg_proof(
